...
const LearningPaths = () => {
    const paths = [
        {
            title: 'Agri-Tech & Sustainable Farming',
            description: 'Master modern farming techniques using technology to boost productivity and sustainability in rural agriculture.',
            courses: 12,
            duration: '5 months',
            level: 'Intermediate',
            image: 'https://placehold.co/400x250?text=AgriTech+Path',
            color: 'from-yellow-600 to-orange-600'
        },
        {
            title: 'Handicraft & Artisan Skills Development',
            description: 'Develop skills in traditional crafts and learn how to market handmade products to a global audience.',
            courses: 8,
            duration: '4 months',
            level: 'Beginner to Intermediate',
            image: 'https://placehold.co/400x250?text=Handicraft+Path',
            color: 'from-indigo-600 to-purple-600'
        },
        {
            title: 'Financial Literacy for Rural Communities',
            description: 'Understand personal and business finances, budgeting, and investment options for rural entrepreneurs.',
            courses: 7,
            duration: '3 months',
            level: 'Beginner',
            image: 'https://placehold.co/400x250?text=Financial+Literacy+Path',
        ...
        <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-800 mb-4 font-museo">Rural Empowerment Learning Paths</h2>
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        These learning paths are designed to empower rural communities with the skills they need to succeed in today’s world.
                    </p>
                </div>
                        ...
                        <div key={index} className="bg-white rounded-xl overflow-hidden shadow-md border border-gray-200 flex flex-col">
                            ...
                            <div className="px-6 pb-6">
                                <a
                                    ...
                                    className="w-full block py-3 px-4 text-center font-medium bg-yellow-600 hover:bg-yellow-700 text-white rounded-md transition"
                                >
                                    Explore Path
                                </a>
                            </div>
